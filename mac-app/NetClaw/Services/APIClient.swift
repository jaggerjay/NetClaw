...
final class APIClient {
    ...
    func downloadHAR(query: SessionQuery = SessionQuery()) async throws -> Data {
        var components = URLComponents(url: baseURL.appendingPathComponent("/api/export/har"), resolvingAgainstBaseURL: false)!
        var items: [URLQueryItem] = []
